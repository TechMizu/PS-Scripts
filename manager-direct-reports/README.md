...
This was an odd request from a manager but an interesting to work on.

This script sends an email to each mananager with the list of users who directly reports to them in AD. 
The email contains html in the body to show the information: Name, Title, Group in AD. It also sends as attachment a csv file with the same information.
